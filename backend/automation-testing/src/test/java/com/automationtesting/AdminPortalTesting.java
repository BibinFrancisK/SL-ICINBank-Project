...
public class AdminPortalTesting {
	...
	public void manageBlockedAccounts() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/app-root/app-admin/app-admin-list/div/div/div[2]/form/div/div[2]/a"))
				.click();
		Thread.sleep(3000);
		Assert.assertEquals(driver.getCurrentUrl(), "http://localhost:4200/admin/blocked-accounts");
		driver.findElement(
				By.xpath("/html/body/app-root/app-admin/app-admin-block-accounts/div/div[2]/table/tr[2]/td[4]/button"))
				.click();
		Thread.sleep(3000);
	...
	public void manageChequeBookRequests() throws InterruptedException {
		...
		driver.findElement(
				By.xpath("/html/body/app-root/app-admin/app-admin-list/div/div/div[2]/form/div/div[3]/a/span")).click();
		Thread.sleep(1000);
		driver.findElement(
				By.xpath("/html/body/app-root/app-admin/app-cheque-requests/div/div[2]/table/tr[2]/td[5]/span"))
				.click();
		Thread.sleep(3000);
		Alert alert = driver.switchTo().alert();
		String msg = alert.getText();
	...
	public void manageUserTransactions() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/app-root/app-admin/app-admin-list/div/div/div[2]/form/div/div[4]/a"))
				.click();
		Thread.sleep(1000);
		driver.findElement(
				By.xpath("/html/body/app-root/app-admin/app-transaction-requests/div/div[2]/table/tr[2]/td[8]/button"))
				.click();
		Thread.sleep(3000);
		Alert alert = driver.switchTo().alert();
		alert.accept();
	...
	public void adminLogout() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/app-root/app-admin/app-admin-list/div/div/div[2]/form/div/div[5]/a"))
				.click();
		Thread.sleep(3000);
